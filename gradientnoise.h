...
public:
    ...
    double tempfunc(std::uint64_t rand){
        rand = (rand + ((rand*17 << 17) % 2147483647ULL));
        return ((((rand % 2305843009213693951ULL)% 524287)% 131071)&8191);
    }
    double noise(double x, double y) {
        Xorshift128plus xorshifter;
        ...
        tempval = tempfunc(xorshifter());
        tempval /= tempdiv;
        tempval *= tempmul;
        corner_0_contrib = glm::dot(glm::vec2(cos(tempval)*sqrt(2), sin(tempval)*sqrt(2)), {dist_x, dist_y});
        ...
        tempval /= tempdiv;
        tempval *= tempmul;
        corner_1_contrib = glm::dot(glm::vec2(cos(tempval)*sqrt(2), sin(tempval)*sqrt(2)), {dist_x, dist_y - 1});
        ...
        tempval /= tempdiv;
        tempval *= tempmul;
        corner_2_contrib = glm::dot(glm::vec2(cos(tempval)*sqrt(2), sin(tempval)*sqrt(2)), {dist_x - 1, dist_y - 1});
        ...
        tempval /= tempdiv;
        tempval *= tempmul;
        corner_3_contrib = glm::dot(glm::vec2(cos(tempval)*sqrt(2), sin(tempval)*sqrt(2)), {dist_x - 1, dist_y});
